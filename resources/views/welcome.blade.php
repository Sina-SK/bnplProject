        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="flex items-center gap-8">
                    <a href="#" @click.prevent="setPage('home')" class="flex items-center gap-2.5">
                        <div class="w-12 h-12 flex items-center justify-center">
                            <!-- SVG logo: Ascending installment graph chart and scheduling nodes -->
                            <svg class="w-full h-full" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <defs>
                                    <linearGradient id="chartGradHeader" x1="0%" y1="0%" x2="100%" y2="100%">
                                        <stop offset="0%" stop-color="#6366f1" />
                                        <stop offset="100%" stop-color="#312e81" />
                                    </linearGradient>
                                    <linearGradient id="lineGradHeader" x1="0%" y1="0%" x2="100%" y2="0%">
                                        <stop offset="0%" stop-color="#10b981" />
                                        <stop offset="100%" stop-color="#6366f1" />
                                    </linearGradient>
                                </defs>
                                <!-- Coordinate Background grid (Subtle) -->
                                <path d="M8 42H42" stroke="#f1f5f9" stroke-width="2" stroke-linecap="round" />
                                <path d="M8 8V42" stroke="#f1f5f9" stroke-width="2" stroke-linecap="round" />
                                
                                <!-- Ascending Payment Bars -->
                                <rect x="11" y="26" width="5" height="12" rx="2.5" fill="#e2e8f0" />
                                <rect x="19" y="19" width="5" height="19" rx="2.5" fill="#cbd5e1" />
                                <rect x="27" y="11" width="5" height="27" rx="2.5" fill="url(#chartGradHeader)" />
                                
                                <!-- Chronological Installment Milestone Line -->
                                <path d="M13.5 32 L21.5 28.5 L29.5 24.5 L38.5 15" stroke="url(#lineGradHeader)" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
                                
                                <!-- Chronological Installment Milestone Dots -->
                                <circle cx="13.5" cy="32" r="3.5" fill="#10b981" stroke="white" stroke-width="2" />
                                <circle cx="21.5" cy="28.5" r="3.5" fill="#10b981" stroke="white" stroke-width="2" />
                                <circle cx="29.5" cy="24.5" r="3.5" fill="#6366f1" stroke="white" stroke-width="2" />
                                <circle cx="38.5" cy="15" r="5" fill="#4f46e5" stroke="white" stroke-width="2" />
                                
                                <!-- Arrowhead demonstrating successful future credit/payment path -->
                                <path d="M34 13.5 L39.5 13.5 L39.5 19" stroke="#4f46e5" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </div>
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                        ...
                        <div class="lg:col-span-7 space-y-8 text-center lg:text-right">
                            ...
                            <h1 style="line-height:1.25" class="text-3xl sm:text-5xl lg:text-6xl font-black text-slate-900 leading-tight">
                                امروز بخرید، <br>
                ...
                <div class="space-y-4">
                    <a href="#" class="flex items-center gap-2.5">
                        <div class="w-10 h-10 flex items-center justify-center">
                            ...
                            <svg class="w-full h-full" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <defs>
                                    <linearGradient id="chartGradFooter" x1="0%" y1="0%" x2="100%" y2="100%">
                                        <stop offset="0%" stop-color="#6366f1" />
                                        <stop offset="100%" stop-color="#312e81" />
                                    </linearGradient>
                                    <linearGradient id="lineGradFooter" x1="0%" y1="0%" x2="100%" y2="0%">
                                        <stop offset="0%" stop-color="#10b981" />
                                        <stop offset="100%" stop-color="#6366f1" />
                                    </linearGradient>
                                </defs>
                                <path d="M8 42H42" stroke="#1e293b" stroke-width="2" stroke-linecap="round" />
                                <path d="M8 8V42" stroke="#1e293b" stroke-width="2" stroke-linecap="round" />
                                
                                <rect x="11" y="26" width="5" height="12" rx="2.5" fill="#1e293b" />
                                <rect x="19" y="19" width="5" height="19" rx="2.5" fill="#334155" />
                                <rect x="27" y="11" width="5" height="27" rx="2.5" fill="url(#chartGradFooter)" />
                                
                                <path d="M13.5 32 L21.5 28.5 L29.5 24.5 L38.5 15" stroke="url(#lineGradFooter)" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
                                
                                <circle cx="13.5" cy="32" r="3.5" fill="#10b981" stroke="#0f172a" stroke-width="2" />
                                <circle cx="21.5" cy="28.5" r="3.5" fill="#10b981" stroke="#0f172a" stroke-width="2" />
                                <circle cx="29.5" cy="24.5" r="3.5" fill="#6366f1" stroke="#0f172a" stroke-width="2" />
                                <circle cx="38.5" cy="15" r="5" fill="#4f46e5" stroke="#0f172a" stroke-width="2" />
